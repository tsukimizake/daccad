...
pub struct CadhrLangFileContents;
...
impl Plugin for UiPlugin {
    fn build(&self, app: &mut App) {
        ...
        use setup::*;
        use update::{egui_ui, file_loaded, file_saved, handle_cadhr_lang_output, on_preview_generated, update_preview_transforms, threemf_saved};

        app.add_plugins(EguiPlugin::default())
            .add_plugins(
                FileDialogPlugin::new()
                    .with_save_file::<CadhrLangFileContents>()
                    .with_load_file::<CadhrLangFileContents>()
            ...
            .add_systems(Update, (on_preview_generated, update_preview_transforms, handle_cadhr_lang_output))
